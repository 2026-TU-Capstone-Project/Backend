...
Spring Boot 기반 백엔드 프로젝트입니다. Gemini-3.1-flash-image API를 활용한 Virtual Try-On 기능을 제공하며, Docker 환경에서 PostgreSQL과 Redis와 함께 실행됩니다.
...
- **AI Engine**: **Google Gemini 3.1 Flash-Image** (가상 피팅) & **Google Gemini 2.5 Flash** (의류 분석)
- **Cache**: Redis 7
- **ORM**: Spring Data JPA
